...
import {createStudent, getStudentById, addGrade, getGradeById, getAverageOfStudent} from '../controllers/StudentConroller.js';
import { login , registerTeacher, registerStudent} from '../controllers/loginController.js';
import  {authMiddleware, Is_Teacher}  from '../middleWare/token.js';
